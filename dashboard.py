...
# Source Address ex: source_address = 'bob123@gmail.com'
source_address = ''
# Destination Address ex: dest_address = 'jill456@gmail.com'
dest_address = ''
# Password for source_address email
password = ''
# IMAP information for Google emails
            ...
            if profile:
                ...
                if temperature_limit != temperature_threshold:
                    ...
                    send_email(f"{profile_name} has just logged into the greatest dashboard ever!",
                               "You've entered the mainframe and your settings are updated.")
